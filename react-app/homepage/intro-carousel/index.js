...
class IntroCarousel extends React.Component{
  constructor (props) {
    super(props);
    this.state = {
      searchFor: "search key"
    }
  }
  search (){
    console.log("Dont know what to do with search string : "+this.state.searchFor);
  }
  setSearchKey (e){
    this.setState({
          ...
          <div className="site-manu container">
            ...
            <div className="banner-serch-box">
              <input id="txtSearchBox"
                     ...
                     type="text"/>
              <a href="javascript:void(0);" onClick={() => this.search()}><i className="fa fa-search" aria-hidden="true"/></a>
            </div>
          </div>
          {/* Carousel items */}
